        ...
        var t = {
                9698: function (t, e, n) {
                    ...
                    class u extends r.EmbedBlot {
                        attach() {
                            super.attach(),
                                (this.attributes = new r.AttributorStore(
                                    this.domNode
                                ));
                        }
                        delta() {
                        ...
                        format(t, e) {
                            const n = this.scroll.query(
                                t,
                                r.Scope.BLOCK_ATTRIBUTE
                            );
                    ...
                    class s extends r.EmbedBlot {
                        ...
                        format(t, e) {
                            ...
                            for (
                                ;
                                null != n &&
                                n.statics.scope !== r.Scope.BLOCK_BLOT;
                        ...
                        restore() {
                            ...
                            const e =
                                    this.prev instanceof i.A ? this.prev : null,
                                n = e ? e.length() : 0,
                    ...
                    class o extends r.EmbedBlot {
                        constructor(t, e) {
                            super(t, e),
                                ...
                                Array.from(this.domNode.childNodes).forEach(
                                    (t) => {
                        ...
                        update(t, e) {
                            t.forEach((t) => {
                                if (
                                    "characterData" === t.type &&
                                    (t.target === this.leftGuard ||
                                        t.target === this.rightGuard)
                                ) {
                ...
                3729: function (t, e, n) {
                    ...
                    class m extends u.ScrollBlot {
                        ...
                        emitUnmount(t) {
                            this.emitter.emit(
                                f.A.events.SCROLL_BLOT_UNMOUNT,
                                t
                            );
                        }
                        emitEmbedUpdate(t, e) {
                            this.emitter.emit(
                                f.A.events.SCROLL_EMBED_UPDATE,
                                t,
                                e
                            );
                        }
                        deleteAt(t, e) {
                            ...
                            if (
                                ...
                                const t =
                                    o.children.head instanceof s.A
                                        ? null
                                        : o.children.head;
                        ...
                        insertAt(t, e, n) {
                            if (t >= this.length())
                                if (
                                    null == n ||
                                    null == this.scroll.query(e, u.Scope.BLOCK)
                                ) {
                        ...
                        insertContents(t, e) {
                            ...
                            if (s) {
                                ...
                                const l = (0, i.Ji)(this.line(t)[0]),
                                    a =
                                        h.AttributeMap.diff(l, s.attributes) ||
                                        {};
                                ...
                                n.forEach((t) => {
                                    if ("block" === t.type)
                                        ...
                                        this.insertBefore(e, o || void 0),
                                            Object.keys(t.attributes).forEach(
                                                (n) => {
                                                    e.format(
                                                        n,
                                                        t.attributes[n]
                        ...
                        isEnabled() {
                            return (
                                "true" ===
                                this.domNode.getAttribute("contenteditable")
                            );
                        }
                        leaf(t) {
                            ...
                            if (!e) return [null, -1];
                            const [n, r] = e;
                            return n instanceof u.LeafBlot
                                ? [n, r]
                                : [null, -1];
                        }
                        line(t) {
                        ...
                        update(t) {
                            if (this.batch)
                                return void (
                                    Array.isArray(t) &&
                                    (this.batch = this.batch.concat(t))
                                );
                            ...
                            "string" == typeof t && (e = t),
                                ...
                                (t = t.filter((t) => {
                                    ...
                                    this.emitter.emit(
                                        f.A.events.SCROLL_BEFORE_UPDATE,
                                        e,
                                        t
                                    ),
                                ...
                                t.length > 0 &&
                                    this.emitter.emit(
                                        f.A.events.SCROLL_UPDATE,
                                        e,
                                        t
                                    );
                        }
                        updateEmbedAt(t, e, n) {
                            const [r] = this.descendant(
                                (t) => t instanceof i.zo,
                                t
                            );
                            r &&
                                r.statics.blotName === e &&
                                g(r) &&
                                r.updateContent(n);
                        }
                        handleDragStart(t) {
                        ...
                        createBlock(t, e) {
                            ...
                            Object.entries(t).forEach((t) => {
                                let [e, i] = t;
                                null !=
                                this.query(e, u.Scope.BLOCK & u.Scope.BLOT)
                                    ? (n = e)
                                    : (r[e] = i);
                            });
                            const i = this.create(
                            ...
                            if (null != n.insert)
                                if ("string" == typeof n.insert) {
                                    ...
                                    if (
                                        ...
                                        null !=
                                            t.scroll.query(r, u.Scope.INLINE))
                                    ) {
                    ...
                    class N extends x.A {
                        ...
                        constructor(t, e) {
                            super(t, e),
                                this.quill.on(
                                    r.Ay.events.EDITOR_CHANGE,
                                    (t, e, n, i) => {
                                        t === r.Ay.events.SELECTION_CHANGE
                                            ? e &&
                                              i !== r.Ay.sources.SILENT &&
                                              (this.currentRange = e)
                    ...
                    class k extends x.A {
                        constructor(t, e) {
                            super(t, e),
                                t.root.addEventListener("drop", (e) => {
                                    ...
                                    const r =
                                        n && t.selection.normalizeNative(n);
                                    if (r) {
                                        const n =
                                            t.selection.normalizedToRange(r);
                        ...
                        upload(t, e) {
                            ...
                            Array.from(e).forEach((t) => {
                                t &&
                                    this.options.mimetypes?.includes(t.type) &&
                                    n.push(t);
                            }),
                                n.length > 0 &&
                                    this.options.handler.call(this, t, n);
                        }
                    }
                    k.DEFAULTS = {
                        ...
                        constructor(t, e) {
                            super(t, e),
                                ...
                                /Android/i.test(navigator.userAgent) ||
                                    t.on(
                                        r.Ay.events.COMPOSITION_BEFORE_START,
                                        () => {
                        ...
                        handleArrowKeys() {
                            this.quill.keyboard.addBinding({
                                ...
                                handler(t, e) {
                                    ...
                                    if (
                                        !(n instanceof u.ParentBlot && n.uiNode)
                                    )
                                        return !0;
                                    const s =
                                        "rtl" ===
                                        getComputedStyle(n.domNode).direction;
                                    return (
                                        !!(
                                            (s && "ArrowRight" !== i.key) ||
                                            (!s && "ArrowLeft" !== i.key)
                    ...
                    [
                        ...
                        document.addEventListener(t, function () {
                            for (
                                ...
                                e[n] = arguments[n];
                            Array.from(
                                document.querySelectorAll(".ql-container")
                            ).forEach((t) => {
                                const n = i.A.get(t);
                ...
                6142: function (t, e, n) {
                    ...
                    function m(t, e, n) {
                        ...
                        if (t instanceof i.ParentBlot) {
                            ...
                            const { outerHTML: s, innerHTML: o } = t.domNode,
                                [l, a] = s.split(`>${o}<`);
                            return "<table" === l
                                ? `<table style="border: 1px solid #000;">${i.join(
                                      ""
                                  )}<${a}`
                                : `${l}>${i.join("")}<${a}`;
                        }
                        return t.domNode instanceof Element
                            ? t.domNode.outerHTML
                            : "";
                    }
                    function b(t, e) {
                    ...
                    var x = class {
                                    ...
                                    (function (t) {
                                        ...
                                        if (null != n.insert) {
                                            if (
                                                ...
                                                a =
                                                    s.AttributeMap.diff(d, a) ||
                                                    {};
                                            } else if (
                                                "object" == typeof n.insert
                                            ) {
                                                const o = Object.keys(
                                                    n.insert
                                                )[0];
                                            ...
                                            (l.push(n),
                                            null !== n.retain &&
                                                "object" == typeof n.retain)
                                        ) {
                                            const e = Object.keys(n.retain)[0];
                                            if (null == e) return t;
                                            this.scroll.updateEmbedAt(
                                                t,
                                                e,
                                                n.retain[e]
                                            );
                            ...
                            insertContents(t, e) {
                                ...
                                return (
                                    this.scroll.insertContents(t, n),
                                    this.update(r)
                                );
                            }
                            insertEmbed(t, e, n) {
                            ...
                            isBlank() {
                                ...
                                return (
                                    !(e.children.length > 1) &&
                                    e.children.head instanceof u.A
                                );
                            }
                            removeFormat(t, e) {
                        ...
                        _ = class {
                            ...
                            handleCompositionStart(t) {
                                ...
                                !e ||
                                    e instanceof k.A ||
                                    (this.emitter.emit(
                                        N.A.events.COMPOSITION_BEFORE_START,
                                        t
                                    ),
                                    this.scroll.batchStart(),
                                    this.emitter.emit(
                                        N.A.events.COMPOSITION_START,
                                        t
                                    ),
                                    (this.isComposing = !0));
                            }
                            handleCompositionEnd(t) {
                                this.emitter.emit(
                                    N.A.events.COMPOSITION_BEFORE_END,
                                    t
                                ),
                                    this.scroll.batchEnd(),
                                    this.emitter.emit(
                                        N.A.events.COMPOSITION_END,
                                        t
                                    ),
                                    (this.isComposing = !1);
                            }
                    ...
                    const S = (t) => {
                            const e = t.getBoundingClientRect(),
                                n =
                                    ("offsetWidth" in t &&
                                        Math.abs(e.width) / t.offsetWidth) ||
                                    1,
                                r =
                                    ("offsetHeight" in t &&
                    ...
                    class I {
                        ...
                        constructor(t) {
                            ...
                            if (!l || !("blotName" in l))
                                throw new Error(
                                    `Cannot initialize Quill without "${s}" blot`
                                );
                            if (
                                ((this.scroll = new l(
                                ...
                                (this.selection = new f.A(
                                    this.scroll,
                                    this.emitter
                                )),
                                (this.composition = new _(
                                    this.scroll,
                                    this.emitter
                                )),
                                ...
                                this.emitter.on(
                                    ...
                                    (t, e) => {
                                        ...
                                        D.call(
                                            this,
                                            () =>
                                                this.editor.update(null, e, i),
                                            t
                                        );
                                    }
                                ),
                                this.emitter.on(
                                    N.A.events.SCROLL_EMBED_UPDATE,
                                    (t, e) => {
                                        const n = this.selection.lastRange,
                                            [r] = this.selection.getRange(),
                                            i =
                            ...
                            return D.call(
                                ...
                                () => {
                                    ...
                                    if (this.scroll.query(t, i.Scope.BLOCK))
                                        ...
                                        if (0 === n.length)
                                            return (
                                                this.selection.format(t, e), r
                                            );
                                        r = this.editor.formatText(
                                            n.index,
                                            n.length,
                                            { [t]: e }
                                        );
                        ...
                        setSelection(t, e, n) {
                            null == t
                                ...
                                : (([t, e, , n] = P(t, e, n)),
                                  this.selection.setRange(
                                      new f.Q(Math.max(0, t), e),
                                      n
                                  ),
                                  n !== N.A.sources.SILENT &&
                                      this.scrollSelectionIntoView());
                        }
                        setText(t) {
                            let e =
                    ...
                    function z(t, e, n, r) {
                        ...
                        return (
                            e && "function" == typeof e.transformPosition
                                ? ([s, o] = [t.index, t.index + t.length].map(
                                      (t) =>
                                          e.transformPosition(
                                              t,
                                              r !== N.A.sources.USER
                    ...
                    e.A = class {
                        constructor(t, e) {
                            (this.emitter = e),
                                ...
                                (this.cursor = this.scroll.create(
                                    "cursor",
                                    this
                                )),
                                ...
                                this.emitter.on(
                                    o.A.events.SCROLL_BEFORE_UPDATE,
                                    () => {
                        ...
                        handleComposition() {
                            this.emitter.on(
                                o.A.events.COMPOSITION_BEFORE_START,
                                () => {
                                    this.composing = !0;
                                }
                            ),
                                this.emitter.on(
                                    o.A.events.COMPOSITION_END,
                                    () => {
                                        if (
                                            ((this.composing = !1),
                                            this.cursor.parent)
                        ...
                        normalizedToRange(t) {
                            ...
                            t.native.collapsed ||
                                e.push([t.end.node, t.end.offset]);
                            const n = e.map((t) => {
                                    const [e, n] = t,
                        ...
                        update() {
                            ...
                            if (
                                ...
                                this.emitter.emit(
                                    o.A.events.EDITOR_CHANGE,
                                    ...n
                                ),
                                    t !== o.A.sources.SILENT &&
                                        this.emitter.emit(...n);
                            }
                        }
                    };
                ...
                9609: function (t, e) {
                    ...
                    class n {
                        ...
                        addModule(t) {
                            const e = this.quill.constructor.import(
                                `modules/${t}`
                            );
                            return (
                    ...
                    class u extends a.A {
                        ...
                        code(t, e) {
                            return this.children
                                .map((t) =>
                                    t.length() <= 1 ? "" : t.domNode.innerText
                                )
                                .join("\n")
                                .slice(t, t + e);
                        }
                ...
                584: function (t, e, n) {
                            ...
                            [
                                ...
                                function (t, e, n) {
                                    ...
                                    return (
                                        "italic" === i.fontStyle &&
                                            (r.italic = !0),
                                        "underline" === i.textDecoration &&
                                            (r.underline = !0),
                                        "line-through" === i.textDecoration &&
                                            (r.strike = !0),
                                        (i.fontWeight?.startsWith("bold") ||
                                            parseInt(i.fontWeight, 10) >=
                                                700) &&
                                            (r.bold = !0),
                                        (e = Object.entries(r).reduce(
                                            (t, e) => {
                                                let [r, i] = e;
                                                return O(t, r, i, n);
                                            },
                    ...
                    class S extends a.A {
                        ...
                        convert(t) {
                            ...
                            return T(i, "\n") &&
                                (null == i.ops[i.ops.length - 1].attributes ||
                                    r.table)
                                ? i.compose(
                                      new (s())()
                                          .retain(i.length() - 1)
                        ...
                        onCapturePaste(t) {
                            ...
                            if (!n && !r) {
                                const e =
                                    t.clipboardData?.getData("text/uri-list");
                            ...
                            if (!n && i.length > 0)
                                ...
                                if (n && i.length > 0) {
                                    ...
                                    if (
                                        ...
                                        "IMG" ===
                                            t.body.firstElementChild?.tagName
                                    )
                                        return void this.quill.uploader.upload(
                                            e,
                                            i
                                        );
                                }
                ...
                8123: function (t, e, n) {
                    ...
                    const h = (0, c.A)("quill:keyboard"),
                        d = /Mac/i.test(navigator.platform)
                            ? "metaKey"
                            : "ctrlKey";
                    class f extends u.A {
                        static match(t, e) {
                        ...
                        constructor(t, e) {
                            super(t, e),
                                (this.bindings = {}),
                                Object.keys(this.options.bindings).forEach(
                                    (t) => {
                        ...
                        listen() {
                            this.quill.root.addEventListener("keydown", (t) => {
                                ...
                                const [s, o] = this.quill.getLine(i.index),
                                    ...
                                    p =
                                        c instanceof l.TextBlot
                                            ? c.value().slice(0, u)
                                            : "",
                                    g =
                                        h instanceof l.TextBlot
                                            ? h.value().slice(d)
                                            : "",
                                    m = {
                                        collapsed: 0 === i.length,
                                        empty:
                                            0 === i.length && s.length() <= 1,
                                ...
                                e.some((t) => {
                                    ...
                                    return !(
                                        (null != t.prefix &&
                                            !t.prefix.test(m.prefix)) ||
                                        (null != t.suffix &&
                                            !t.suffix.test(m.suffix)) ||
                            ...
                            "code exit": {
                                ...
                                handler(t) {
                                    ...
                                    for (
                                        ...
                                        null != i &&
                                        i.length() <= 1 &&
                                        i.formats()["code-block"];

                                    )
                                        if (((i = i.prev), (r -= 1), r <= 0)) {
                                            const r = new (o())()
                                                .retain(
                                                    t.index + e.length() - n - 2
                                                )
                                                .retain(1, {
                                                    "code-block": null,
                                                })
                ...
                8920: function (t) {
                    ...
                    Object.create &&
                        ...
                        (l.prototype.listeners = function (t) {
                            ...
                            if (r.fn) return [r.fn];
                            for (
                                var i = 0, s = r.length, o = new Array(s);
                                i < s;
                                i++
                            )
                                o[i] = r[i].fn;
                        ...
                        (l.prototype.emit = function (t, e, r, i, s, o) {
                            ...
                            if (u.fn) {
                                switch (
                                    ...
                                    case 4:
                                        return (
                                            u.fn.call(u.context, e, r, i), !0
                                        );
                                    case 5:
                                        return (
                                            u.fn.call(u.context, e, r, i, s), !0
                                        );
                                    case 6:
                                        return (
                                            u.fn.call(u.context, e, r, i, s, o),
                                            !0
                                        );
                                }
                ...
                5090: function (t) {
                    ...
                    function o(t, e) {
                        ...
                        for (
                            ...
                            t.substring(s, i) == e.substring(s, i)
                                ? (s = n = i)
                                : (r = i),
                    ...
                    function l(t, e) {
                        ...
                        for (var s = 0, o = 1; ; ) {
                            ...
                            (o += a),
                                (0 != a &&
                                    t.substring(i - o) != e.substring(0, o)) ||
                                    ((s = o), o++);
                        }
                    }
                    function a(t, e) {
                ...
                9629: function (t, e, n) {
                    ...
                    function jt(t, e, n, r, i, f, y) {
                        var T;
                        if ((r && (T = f ? r(t, i, f, y) : r(t)), void 0 !== T))
                            return T;
                        if (!Wt(t)) return t;
                        var j = Ht(t);
                        if (j) {
                    ...
                    (kt.prototype.clear = function () {
                        ...
                        (kt.prototype.set = function (t, e) {
                            return (
                                (this.__data__[t] = yt && void 0 === e ? r : e),
                                this
                            );
                        }),
                        ...
                        (_t.prototype.delete = function (t) {
                            ...
                            return !(
                                n < 0 ||
                                (n == e.length - 1 ? e.pop() : ct.call(e, n, 1),
                                0)
                            );
                        }),
                ...
                4162: function (t, e, n) {
                    ...
                    (Et.prototype.clear = function () {
                        ...
                        (wt.prototype.delete = function (t) {
                            ...
                            return !(
                                n < 0 ||
                                (n == e.length - 1 ? e.pop() : st.call(e, n, 1),
                                --this.size,
                                0)
                            );
                        }),
                ...
                6003: function (t, e, n) {
                            ...
                            return t.map((t) => {
                                ...
                                return (
                                    ...
                                    n
                                        ...
                                        : e &&
                                          (t.className &&
                                              (this.classes[t.className] = t),
                                          t.tagName &&
                                              (Array.isArray(t.tagName)
                                                  ? (t.tagName = t.tagName.map(
                                                        (t) => t.toUpperCase()
                                                    ))
                                                  : (t.tagName =
                        ...
                        d = class {
                            ...
                            build() {
                                ...
                                e.concat(n)
                                    .concat(s)
                                    .forEach((e) => {
                                        const n = t.scroll.query(
                                            e,
                                            r.ATTRIBUTE
                                        );
                                        n instanceof i &&
                                            (this.attributes[n.attrName] = n);
                                    });
                            }
                            copy(t) {
                                Object.keys(this.attributes).forEach((e) => {
                                    const n = this.attributes[e].value(
                                        this.domNode
                                    );
                                    t.format(e, n);
                                });
                        ...
                        f = class {
                            ...
                            formatAt(t, e, n, i) {
                                ...
                                if (null != this.scroll.query(n, r.BLOT) && i)
                                    ...
                                    null != this.scroll.query(n, r.ATTRIBUTE)
                                ) {
                                    const t = this.scroll.create(
                                        this.statics.scope
                                    );
                    ...
                    const v = class t extends p {
                        ...
                        attachUI(e) {
                            null != this.uiNode && this.uiNode.remove(),
                                (this.uiNode = e),
                                t.uiClass &&
                                    this.uiNode.classList.add(t.uiClass),
                                this.uiNode.setAttribute(
                                    "contenteditable",
                                    "false"
                                ),
                        ...
                        replaceWith(e, n) {
                            const r =
                                "string" == typeof e
                                    ...
                                    : e;
                            return (
                                r instanceof t && this.moveChildren(r),
                                super.replaceWith(r)
                            );
                        }
                        split(t, e = !1) {
                    ...
                    const A = v,
                        x = class t extends A {
                            ...
                            formatAt(t, e, n, i) {
                                null != this.formats()[n] ||
                                this.scroll.query(n, r.ATTRIBUTE)
                            ...
                            wrap(e, n) {
                                ...
                                return (
                                    r instanceof t && this.attributes.move(r), r
                                );
                            }
                        };
                    ...
                    const N = x,
                        E = class t extends A {
                            ...
                            insertAt(t, e, n) {
                                if (
                                    null == n ||
                                    null != this.scroll.query(e, r.INLINE)
                                )
                                    super.insertAt(t, e, n);
                                else {
                        ...
                        S = class extends A {
                            ...
                            update(t, e = {}) {
                                ...
                                t
                                    ...
                                    (e.mutationsMap = n),
                                    n.has(this.domNode) &&
                                        super.update(n.get(this.domNode), e),
                                    this.optimize(t, e);
                            }
                        };
                    (S.blotName = "scroll"),
            ...
            (function () {
                ...
                class o extends s.ClassAttributor {
                    add(t, e) {
                        ...
                        return 0 === n
                            ? (this.remove(t), !0)
                            : super.add(t, n.toString());
                    }
                    canAdd(t, e) {
                        return (
                            super.canAdd(t, e) ||
                            super.canAdd(t, parseInt(e, 10))
                        );
                    }
                    value(t) {
                ...
                class w extends x.A {
                    ...
                    static sanitize(t) {
                        return q(t, this.PROTOCOL_WHITELIST)
                            ? t
                            : this.SANITIZED_URL;
                    }
                    format(t, e) {
                ...
                class Z extends x.A {
                    static formats(t, e) {
                        for (; null != t && t !== e.domNode; ) {
                            if (
                                t.classList &&
                                t.classList.contains(D.Ay.className)
                            )
                ...
                class G extends D.Ay {
                    static create(t) {
                        ...
                        return (
                            "string" == typeof t &&
                                e.setAttribute("data-language", t),
                            e
                        );
                    }
                    static formats(t) {
                ...
                class Q extends F.A {
                    ...
                    initListener() {
                        this.quill.on(p.Ay.events.SCROLL_BLOT_MOUNT, (t) => {
                            ...
                            const e =
                                this.quill.root.ownerDocument.createElement(
                                    "select"
                                );
                            this.options.languages.forEach((t) => {
                                let { key: n, label: r } = t;
                                const i =
                                    e.ownerDocument.createElement("option");
                                (i.textContent = r),
                    ...
                    highlight() {
                        ...
                        (null == t
                            ? this.quill.scroll.descendants(X)
                            : [t]
                        ).forEach((t) => {
                            ...
                            null != n &&
                                this.quill.setSelection(n, p.Ay.sources.SILENT);
                    }
                    highlightBlot(t) {
                        let e =
                            arguments.length > 1 && void 0 !== arguments[1]
                        ...
                        const n =
                            this.quill.root.ownerDocument.createElement("div");
                        return (
                            ...
                            (n.innerHTML = ((t, e, n) => {
                                if ("string" == typeof t.versionString) {
                                    ...
                                    if (parseInt(r, 10) >= 11)
                                        return t.highlight(n, { language: e })
                                            .value;
                                }
                ...
                class et extends f.A {
                    ...
                    balanceCells() {
                        const t = this.descendants(Y),
                            e = t.reduce(
                                (t, e) => Math.max(e.children.length, t),
                                0
                            );
                        t.forEach((t) => {
                            new Array(e - t.children.length)
                                .fill(0)
                                .forEach(() => {
                                    let e;
                ...
                class rt extends F.A {
                    ...
                    deleteRow() {
                        ...
                        null != t &&
                            (t.remove(), this.quill.update(p.Ay.sources.USER));
                    }
                    deleteTable() {
                        const [t] = this.getTable();
                        if (null == t) return;
                ...
                class ot extends F.A {
                    constructor(t, e) {
                        if (
                            (super(t, e), Array.isArray(this.options.container))
                        ) {
                        ...
                        this.container instanceof HTMLElement
                            ? (this.container.classList.add("ql-toolbar"),
                              ...
                              this.options.handlers &&
                                  Object.keys(this.options.handlers).forEach(
                                      (t) => {
                    ...
                    attach(t) {
                        let e = Array.from(t.classList).find(
                            (t) => 0 === t.indexOf("ql-")
                        );
                        if (!e) return;
                        if (
                            ...
                            null == this.handlers[e] &&
                                null == this.quill.scroll.query(e))
                        )
                            return void st.warn(
                ...
                var dt = class {
                        ...
                        buildItem(t) {
                            ...
                            return (
                                ...
                                t.textContent &&
                                    e.setAttribute("data-label", t.textContent),
                    ...
                    gt = class {
                        constructor(t, e) {
                            (this.quill = t),
                                ...
                                ((t) => {
                                    const { overflowY: e } = getComputedStyle(
                                        t,
                                        null
                                    );
                ...
                class qt extends gt {
                    constructor(t, e) {
                        super(t, e),
                            (this.textbox =
                                this.root.querySelector('input[type="text"]')),
                            this.listen();
                    }
                    listen() {
                                ...
                                (t, e, n, r) => {
                                    if (t === bt.A.events.SELECTION_CHANGE)
                                        if (
                                            ...
                                            const t = this.quill.getLines(
                                                e.index,
                                                e.length
                                            );
                                            if (1 === t.length) {
                                                const t =
                                                    this.quill.getBounds(e);
